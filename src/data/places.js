export default [
  {
    ...
    content: {
      introduction: "La place de la Bourse de Bordeaux, à l'origine baptisée place Royale, a été réalisée sous l’intendance de Claude Boucher par l'architecte du roi, Ange-Jacques Gabriel, entre 1730 et 17551.",
  ...
  },
  {
    ...
    content: {
      ...
      funfact:"Le Grand-Théâtre présente en vue frontale un portique de 12 colonnes corinthiennes au-dessus desquelles sont alignées 12 statues : les 9 muses et 3 déesses de la mythologie antique."
    },
    pictures: {
      current: {
  ...
  },
  {
    ...
    content: {
      ...
      funfact:"L'ecv l'école des DA du web"
    },
    pictures: {
      current: {
        small: "https://www.lecercledesliberaux.com/wp-content/uploads/2018/08/Cite-du-Vin-Credit-Arnaud-Bertrande_format_1600x900-150x150.jpg",
  ...
  },
  {
    ...
    content: {
      ...
      funfact:" Cette halle s'est effondrée en 1950. La statue monumentale de la façade a disparu."
    },
    pictures: {
      current: {
  ...
  },
  {
    ...
    content: {
      ...
      funfact:"La cloche actuelle pèse 7 800kg pour deux mètres de hauteur et de diamètre."
    },
    pictures: {
      current: {
